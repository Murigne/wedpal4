            ...
            <CardContent>
              <div className="flex flex-col md:flex-row items-center justify-between h-full">
                ...
                <div className="w-full md:w-1/2 h-44 flex items-center justify-center">
                  <div style={{ width: '100%', height: '0%', minHeight: '140px' }}>
                ...
                <ul className="space-y-3">
                  {recentActivities.map((activity, index) => (
                    <li key={index} className="text-sm border-b border-gray-100 pb-3 last:border-0 flex justify-between">
                      ...
                      <span className={`font-medium flex items-center gap-1 ${activity.userName.includes("Partner") ? "text-pink-500" : "text-pink-500"}`}>
